...
Here is my [teaching website <i class="fa fa-external-link" aria-hidden="true"></i>](https://bcdanl.github.io){target="_blank"}.
...
cv_entries %>% 
  ...
  mutate(what = ifelse(!is.na(additional_info), 
    str_c("<span class='cv-entry-title'> <i>", what, "</i>&nbsp; </span><br class='work-break'>", where, "<br>", additional_info),
